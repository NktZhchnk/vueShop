...
<template>
  <div class="main-header">
    ...
    <div class="main-cart" @click="swapCart">
        ...
        <div v-if="store.cartProducts.length !== 0" style="position: relative; bottom: 10px; right: 10px; width:20px; height: 20px; display: flex; align-items: center; justify-content: center; border-radius: 50%; background: #ffff00; color:  #fd00fd">
